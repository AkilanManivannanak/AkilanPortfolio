    ...
    <template #content>
      <div class="flex flex-col w-full text-sm">
        ...
        <div class="flex flex-col p-3">
          ...
          <a href="mailto:ak.akilan.smart22@gmail.com" class="hover:underline py-1"> Contact </a>
          <a
            href="https://github.com/AkilanManivannanak"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/akilan-manivannan-a178212a7/"
            target="_blank"
            class="hover:underline py-1"
          >
            Linkedin
...
export default class UserPopup extends BreakpointMixin {
  ...
  activateAboutMe() {
    ...
    createAlert({
      type: AlertType.Info,
      title: 'Welcome to AkilanFlix!',
      description: `I'm Akilan Manivannan, an AI/ML Engineer specializing in building scalable, high-performance intelligent systems.

Akilanflix is my portfolio — inspired by a popular streaming platform — where you can explore my AI/ML projects, skills and experience. From RAG-enhanced forecasting to real-time computer vision, I architect systems that transform complex data into actionable intelligence.`,
      actions: ({ confirm }) => [
        confirm({
